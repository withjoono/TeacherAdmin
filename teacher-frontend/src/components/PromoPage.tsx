import { GraduationCap, Users, BarChart3, MessageSquare, BookOpen, ArrowRight, Sparkles } from 'lucide-react';
...
export default function PromoPage() {
    return (
        <div className="min-h-screen bg-slate-950 text-white">
            ...
            <header className="sticky top-0 z-50 border-b border-white/5 bg-slate-950/80 backdrop-blur-xl">
                <div className="mx-auto flex h-16 max-w-screen-xl items-center justify-between px-4 sm:px-6">
                    ...
                    <button
                        ...
                        className="rounded-lg bg-white/10 px-5 py-2 text-sm font-medium text-white backdrop-blur-sm transition-all hover:bg-white/20"
                    >
                        로그인
                    </button>
                </div>
            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative mx-auto max-w-screen-xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
                    ...
                    <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        <button
                            onClick={redirectToHubLogin}
                            className="group flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 px-8 py-3.5 text-base font-semibold text-white shadow-xl shadow-emerald-500/25 transition-all hover:shadow-2xl hover:shadow-emerald-500/30"
                        >
                            시작하기
                        ...
                        <a
                            href="#features"
                            className="rounded-xl border border-white/10 bg-white/5 px-8 py-3.5 text-base font-medium text-slate-300 backdrop-blur-sm transition-all hover:bg-white/10"
                        >
                            기능 더 알아보기
                        </a>
                    </div>
                    ...
                    <div className="mx-auto mt-20 grid max-w-2xl gap-px overflow-hidden rounded-2xl border border-white/5 bg-white/5 sm:grid-cols-3">
                        {[
                            ...
                            <div key={i} className="bg-slate-900/50 px-6 py-5 text-center backdrop-blur-sm">
            ...
            {/* Features Section */}
            <section id="features" className="relative border-t border-white/5 bg-slate-900/50 py-24">
                <div className="mx-auto max-w-screen-xl px-4 sm:px-6">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {features.map((feature) => (
                            <div
                                key={feature.title}
                                className="group relative overflow-hidden rounded-2xl border border-white/5 bg-slate-900/80 p-6 backdrop-blur-sm transition-all hover:border-white/10 hover:bg-slate-800/80"
                            >
            ...
            <section className="relative border-t border-white/5 py-24">
                ...
                <div className="relative mx-auto max-w-screen-md px-4 text-center sm:px-6">
                    ...
                    <button
                        onClick={redirectToHubLogin}
                        className="group mt-8 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 px-10 py-4 text-lg font-semibold text-white shadow-xl shadow-emerald-500/25 transition-all hover:shadow-2xl hover:shadow-emerald-500/30"
                    >
                        무료로 시작하기
            ...
            <footer className="border-t border-white/5 bg-slate-950 py-8">
                <div className="mx-auto max-w-screen-xl px-4 text-center sm:px-6">
                    <div className="flex items-center justify-center gap-2 text-slate-600">
                        ...
                        <span className="text-sm">© 2026 선생님 · GB Planner. All rights reserved.</span>
                    </div>
                </div>
            </footer>
        </div>
